...
(function() {
  jQuery(function() {
    ...
    $.extend(true, $.fn.dataTable.defaults, {
      ...
      fnInitComplete: function(oSettings, json) {
        var currentId, thisFilter, thisFilterInput, thisFilterLabel, thisLength, thisLengthLabel, thisLengthSelect;
        ...
        if (currentId) {
          ...
          return thisFilterInput.appendTo(thisFilter).wrap("<div class=\"col-xs-8 col-sm-9 col-md-9 \" />");
        }
      }
    });
